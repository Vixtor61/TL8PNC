...
public class ClienteDAOImpl implements ClienteDAO {
	...
	public int insertClienteAutoId(Cliente c) {
		// TODO Auto-generated method stub
		SimpleJdbcInsert jdbcInsert =  new SimpleJdbcInsert(jdbcTemplate).withSchemaName("store").withTableName("cliente").usingGeneratedKeyColumns("c_cliente");
	...
	public int ejecutarProcedimientoJdbc(Integer cliente, Boolean estado) {
		// TODO Auto-generated method stub
		SimpleJdbcCall jdbcCall = new SimpleJdbcCall(jdbcTemplate).withSchemaName("store").withProcedureName("sp_actualizar_cliente").withoutProcedureColumnMetaDataAccess();
	...
	@Override
	public int[][] bartchInsertVehiculos(List<Vehiculo> vehiculos) {
